...
// Componente principal para gestionar paquetes turísticos
const Packages = () => {
  // Estados para manejar búsqueda, filtros, paginación y datos de paquetes
  const [searchTerm, setSearchTerm] = useState(""); // Término de búsqueda
  const [filterStatus, setFilterStatus] = useState("all"); // Filtro de estado (no implementado en este código)
